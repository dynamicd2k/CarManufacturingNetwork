...
console.log('.....Connecting to channel - carmanufacturingchannel');
const channel = await gateway.getNetwork('carmanufacturingchannel');

// Get instance of deployed Certnet contract
// @param Name of chaincode
// @param Name of smart contract
console.log('.....Connecting to regnet Smart Contract');
return channel.getContract('carnet', 'org.carmanufacturing-network.com-carnet');
}
